...
?>
    ...
    <?php $cb_values= explode(",",esc_html(get_theme_mod( 'colon_blog_post_meta_pill_checkbox','author,date,comments,readmore,image' ))) ; ?>
                                    ...
                                    if(in_array("comments", $cb_values)) :
                                        ?>
                                            <li class="comments-meta">
                                                ...
                                                <span itemprop="commentCount"><a class="post-comments-url" href="<?php the_permalink() ?>#comments"><?php comments_number('0','1','%'); ?> <?php esc_html_e('Comments','colon-plus'); ?></a></span>
                                            </li>
                                        <?php
                                    endif;
                                ?>
                        ...
                        <div class="blog-excerpt">
                            ...
                            <?php
                                if(in_array("readmore", $cb_values)) :
                                    ?>
                                        <div class="read-more">
                                            <a href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e('READ MORE','colon-plus'); ?></a>
                                        </div>
                                    <?php
                                endif;
                            ?>
