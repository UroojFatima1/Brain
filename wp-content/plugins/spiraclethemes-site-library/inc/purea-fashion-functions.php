 ...
 * Add CSS.
 */
if ( ! function_exists( 'spiraclethemes_site_library_purea_fashion_dynamic_css' ) ) :
function spiraclethemes_site_library_purea_fashion_dynamic_css() {
    ?>
        <style type="text/css" id="purea-fashion-admin-style">
...
add_action( 'admin_head', 'spiraclethemes_site_library_purea_fashion_dynamic_css' );
